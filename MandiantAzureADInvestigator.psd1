...
@{
    ...
    # Functions to Export
    FunctionsToExport = 'Connect-MandiantAzureEnvironment','Invoke-MandiantAllChecks','Get-MandiantUnc2452AuditLogs','Invoke-MandiantAuditAzureADDomains','Get-MandiantBulkUAL','Invoke-MandiantAuditAzureADServicePrincipals','Invoke-MandiantAuditAzureADApplications','Disconnect-MandiantAzureEnvironment'
